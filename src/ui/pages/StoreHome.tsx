      ...
      <section className={`relative overflow-hidden rounded-2xl ${hero?.imageUrl? 'p-0' : 'p-6'} shadow-card ${hero?.imageUrl? '' : 'bg-gradient-to-r from-brand-500 to-brand-400 text-white'}`}>
        {hero?.imageUrl ? (
            ...
            <div className="absolute inset-0 flex items-center p-6">
              <div className="max-w-2xl text-white">
                ...
                <div className="mt-4 flex flex-wrap gap-2 text-sm">
                  <Link to="/services/cleaning" className="rounded bg-white/90 px-3 py-1 text-brand-600 hover:bg-white">專業清洗</Link>
                  <Link to="/services/home" className="rounded bg-white/90 px-3 py-1 text-brand-600 hover:bg-white">居家清潔</Link>
                  <Link to="/appliances" className="rounded bg-white/90 px-3 py-1 text-brand-600 hover:bg-white">家電購買</Link>
                  <Link to="/used" className="rounded bg-white/90 px-3 py-1 text-brand-600 hover:bg-white">二手家電</Link>
          ...
          <div className="relative z-10">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-sm">
              <Link to="/services/cleaning" className="rounded-full bg-white/90 px-3 py-1 text-brand-600 hover:bg-white">專業清洗</Link>
              ...
              <Link to="/used" className="rounded-full bg-white/90 px-3 py-1 text-brand-600 hover:bg-white">二手家電</Link>
